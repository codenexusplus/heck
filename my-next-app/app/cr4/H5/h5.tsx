            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[...Array(6)].map((_, index) => (
                <div key={index} className="p-4 border rounded-lg shadow-sm">
                  <h3 className="text-xl font-semibold">Alder Grilled Chinook Salmon</h3>
        ...
        <section className="bg-green-500 py-12 text-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="mb-8 text-gray-200">
              Learn more about our chefs, specialists, and founders.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <div key={index} className="bg-white text-gray-800 rounded-lg shadow-lg p-4">
